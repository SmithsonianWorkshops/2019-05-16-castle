...
venue: "Quarterly SI Data Carpentry: Spring 2019 Edition"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "May 16-17, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-05-16      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-05-17        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Mike Trizna, Jen Hammock, Mauro Lepore, Luis Villanueva, Amanda Devine"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jennifer Giaccai, Matt Kweskin, Mirian Tsuchiya"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-05-16-castle            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 60413115254          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p id="requirements">
  ...
  Mac, Linux, or Windows operating system (not a tablet, Chromebook, etc.) that they have administrative privileges on. <strong>This computer must be able to connect to the Smithsonian's SI-Staff wifi network which requires an SI network account.</strong> They should have a few specific software packages installed (listed <a href="#setup">below</a>).
</p>
